...
# %% ../nbs/21_vision.learner.ipynb 11
def has_pool_type(m):
...
# %% ../nbs/21_vision.learner.ipynb 17
...
# %% ../nbs/21_vision.learner.ipynb 21
def create_head(
    nf,
    n_out,
    lin_ftrs=None,
...
# %% ../nbs/21_vision.learner.ipynb 25
from ..callback.hook import num_features_model

# %% ../nbs/21_vision.learner.ipynb 27
def default_split(m):
...
# %% ../nbs/21_vision.learner.ipynb 32
...
# %% ../nbs/21_vision.learner.ipynb 37
...
def create_unet_model(
    arch, n_out, img_size, pretrained=True, cut=None, n_in=3, **kwargs
):
