...
# %% ../nbs/09c_vision.widgets.ipynb 6
_all_ = [
    "HBox",
    "VBox",
    "widgets",
...
# %% ../nbs/09c_vision.widgets.ipynb 9
...
# %% ../nbs/09c_vision.widgets.ipynb 13
def carousel(
    children: tuple | list = (), **layout  # `Box` objects to display in a carousel
...
# %% ../nbs/09c_vision.widgets.ipynb 17
class ImagesCleaner:
...
# %% ../nbs/09c_vision.widgets.ipynb 22
