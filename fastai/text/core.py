...
# %% ../nbs/30_text.core.ipynb 18
_re_wrep = re.compile(r"(?:\s|^)(\w+)\s+((?:\1\s+)+)\1(\s|\W|$)")

# %% ../nbs/30_text.core.ipynb 20
def replace_wrep(t):
...
# %% ../nbs/30_text.core.ipynb 25
_re_all_caps = re.compile(r"(\s|^)([A-Z]+[^a-z\s]*)(?=(\s|$))")

# %% ../nbs/30_text.core.ipynb 27
...
# %% ../nbs/30_text.core.ipynb 29
_re_maj = re.compile(r"(\s|^)([A-Z][^A-Z\s]*)(?=(\s|$))")

# %% ../nbs/30_text.core.ipynb 31
def replace_maj(t):
...
# %% ../nbs/30_text.core.ipynb 41
WordTokenizer = SpacyTokenizer

# %% ../nbs/30_text.core.ipynb 43
