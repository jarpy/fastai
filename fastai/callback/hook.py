...
# %% ../nbs/15_callback.hook.ipynb 51
def has_params(m):
    "Check if `m` has at least one parameter"
    return len(list(m.parameters())) > 0


# %% ../nbs/15_callback.hook.ipynb 53
@funcs_kwargs
