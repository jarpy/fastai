...
# %% ../nbs/70b_callback.neptune.ipynb 14
class NeptuneCallback(Callback):
    ...
    def __init__(self, log_model_weights=True, keep_experiment_running=False):
        ...
        if neptune.project is None:
            raise ValueError(
                "You did not initialize project in neptune.\n",
    ...
    def after_fit(self):
        if not self.keep_experiment_running:
            ...
            print(
                f"Your experiment (id: {self.experiment.id}, name: {self.experiment.name}) is left in the running state.\n",
